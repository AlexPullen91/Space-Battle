class BossOne extends Phaser.Scene { // creates a scene to be referenced in main.js
  ...
  create() {
    ...
    this.background = this.add.image(0, 0, "background1"); // add the background to the scene
    ...
    this.ship.body.collideWorldBounds = true; // player ship cannot exit world bounds
    Align.scaleToGameW(this.ship, 0.105); // scale shape size
